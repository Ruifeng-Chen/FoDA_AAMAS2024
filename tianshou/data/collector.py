...
class Collector:
    ...
    def __init__(
        ...
        fast_buffer: Optional[ReplayBuffer] = None,
        ...
        self.fast_buffer = fast_buffer if fast_buffer is not None else VectorReplayBuffer(self.env_num, self.env_num)
        self.policy = policy
    ...
    def collect(
        ...
        while True:
            ...
            if n_episode is None:
                acc_return += rew
            # else:
            #     acc_return = [0 for i in ready_env_ids]
                self.data.update(
                    obs_next=obs_next,
                    rew=rew,
                    ...
                    acc_return=np.array(acc_return),
            ...
            _ = self.fast_buffer.add(self.data, buffer_ids=ready_env_ids)
